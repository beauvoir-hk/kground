...
module.exports = ()=>{
    ...
    router.post('/paying_payApp', function(req,res){
        ...
        */
        ...
        var dataString = 'cmd=payrequest&userid=qop1513&goodname=2만포인트구매& '
    ...
    router.post('/paying_feedback', function(req,res){
        ...
        */
        var payapp_userid	= 'qop1513'	          // payapp 판매자 아이디
        var payapp_linkkey	= 'NESMkhRS2bI6O7HxR7OfY+1DPJnCCRVaOgT+oqg6zaM='				// payapp 연동key, 판매자 사이트 로그인 후 설정 메뉴에서 확인 가능
        var payapp_linkval	= 'NESMkhRS2bI6O7HxR7OfY7lD5a0MdKg4gTdHOJF+36w='				// payapp 연동value, 판매자 사이트 로그인 후 설정 메뉴에서 확인 가능
    ...
    router.get('/payConfirm', function(req,res){
