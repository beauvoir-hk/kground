            ...
            function(err, result2){
                if(err){
                    ...
                    if(receipt.length==0){
                        ...
                        if(st==0){
                            console.log("//같은 시스템이 아니니 등록")
                            console.log("이거?",_gamenumber, _gender, _jiyeok, _birth ,add_golfsys)
                            ...
                            connection.query(
                                ...
                                function(err, result2){
                                    if(err){
                                        ...
                                        console.log("my ksfc 총건수result2 =",lensys ) 
                                        for(j=0;j<lensys;j++){
                                            for(i=0;i<len;i++){
                                        ...
                                        console.log("rank[j]=",j,rank[j],_phone,result[j].golfsys )       
                                        const sql=
                                            `
                                            update
                                            ksfc
                                            ...
                                            (err, result3)=>{
                                                if(err){   
                                                    console.log(err)
                                                        ...
                                                        res.render('ksfc_list', {
                                                            'resultt': result,  //bestscore순
                                                            'resultt2': result2,//golfsys
                                                            'username' : _user, 
                                                            'phone': _phone,
                                                            amount:_amount,
                                                            'len': len,
